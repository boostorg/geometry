...
void test_polygon_polygon()
{
    ...
    if ( boost::is_floating_point<typename bg::coordinate_type<P>::type>::value )
    {
        ...
        {
            typedef bg::model::polygon<P, true> poly;
