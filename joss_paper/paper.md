...
A set of resources ranging from contributor guidelines and documentation generation to talks and videos about Boost.Geometry is available on the [project wiki](https://github.com/boostorg/geometry/wiki).
The repository's `test/` and `example/` directories contain unit and regression tests alongside usage examples demonstrating API usage and performance.
