...
private :
                        ...
                        Spheroid const& spheroid)
    {
        ...
        typedef typename formula::elliptic_meridian_arc_length<CT>
                         elliptic_meridian_arc_length;

        bool meridian_not_crossing_pole =
              elliptic_meridian_arc_length::meridian_not_crossing_pole(lat1,
                                                                       lat2,
                                                                       diff);

        bool meridian_crossing_pole =
              elliptic_meridian_arc_length::meridian_crossing_pole(diff);
