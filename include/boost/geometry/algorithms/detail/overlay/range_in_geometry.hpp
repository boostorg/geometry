...
struct point_in_geometry_helper
{
    ...
    {
        return detail::within::point_in_geometry(point, geometry);
    }
};
                                    ...
                                    bool skip_first = false)
{
    ...
    for ( ; it != end; ++it)
    {
        result = point_in_geometry_helper<Geometry2>::apply(*it, geometry2);
        if (result != 0)
        {
            return result;
        }
...
// when it finds a point of geometry1 inside or outside geometry2
template <typename Point1, typename Geometry1, typename Geometry2>
                             ...
                             Geometry2 const& geometry2)
{
    ...
    if (result == 0)
    {
        ...
        result = range_in_geometry(geometry1, geometry2, true);
    }    
    return result;
}
