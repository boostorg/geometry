...
template<
	...
	typename multi_polygon_t = boost::geometry::model::multi_polygon<polygon_t>
	>
static inline void correct_non_zero(polygon_t const &input, multi_polygon_t &output, double remove_spike_min_area = 0.0)
{
...
template<
	...
	typename multi_polygon_t = boost::geometry::model::multi_polygon<polygon_t>
	>
static inline void correct_non_zero(multi_polygon_t const &input, multi_polygon_t &output, double remove_spike_min_area = 0.0)
{
	impl::correct(input, output, remove_spike_min_area, 
		impl::fill_non_zero_winding<point_t, polygon_t, multi_polygon_t>(),
		impl::result_combine_multiple<multi_polygon_t, multi_polygon_t>, 
