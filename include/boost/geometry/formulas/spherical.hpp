                                          ...
                                          Sphere const& sphere)
{
    ...
    CT const norm = math::sqrt(cos_alp1 * cos_alp1 + sin_alp1 * sin_alp1 * sin_lat1 * sin_lat1);
    ...
    CT const norm2 = math::sqrt(cos_alp0 * cos_alp0 * cos_sig2 * cos_sig2 + sin_alp0 * sin_alp0);
